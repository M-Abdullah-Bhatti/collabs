      ...
      <div className="profile__overview__info">
        ...
        <div className="profile__other__info">
            <div className="profile__info">
                <span style={{backgroundColor: '#31AFD4'}}>Musicians Connected</span>
        ...
        <p style={{marginTop: '20px'}}>I am a musician and songwriter, deeply passionate about creating soul-stirring melodies. Music has always been my canvas for self-expression and storytelling. Join me on this journey as I share my love for music and connect with hearts worldwide.</p>
      </div>
    </div>
  )
}
